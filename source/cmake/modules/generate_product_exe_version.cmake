...
#
# This function uses ExeVersionInfo.in template file and VersionResource.rc file
...
function(generate_product_exe_version outfiles)
    ...
    set (_VersionInfoFile ${CMAKE_CURRENT_BINARY_DIR}/ExeVersionInfo.h)
    set (_VersionResourceFile ${CMAKE_CURRENT_BINARY_DIR}/ExeVersionResource.rc)
    configure_file(
        ${GenerateProductVersionCurrentDir}/ExeVersionInfo.in
        ${_VersionInfoFile}
        @ONLY)
    configure_file(
        ${GenerateProductVersionCurrentDir}/ExeVersionResource.rc
