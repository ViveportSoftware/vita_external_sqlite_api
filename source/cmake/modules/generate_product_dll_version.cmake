...
#
# This function uses DllVersionInfo.in template file and DllVersionResource.rc file
...
function(generate_product_dll_version outfiles)
    ...
    set (_VersionInfoFile ${CMAKE_CURRENT_BINARY_DIR}/DllVersionInfo.h)
    set (_VersionResourceFile ${CMAKE_CURRENT_BINARY_DIR}/DllVersionResource.rc)
    configure_file(
        ${GenerateProductVersionCurrentDir}/DllVersionInfo.in
        ${_VersionInfoFile}
        @ONLY)
    configure_file(
        ${GenerateProductVersionCurrentDir}/DllVersionResource.rc
